 ...
 * the factory should be thread safe and part of the environment
 * @author av
 */
public class RequestContextFactoryFinder {
   ...
   * name.
   */
  private static final String CONTEXT_KEY = "net.sf.wcfart.wcf.controller.RequestContextFactory";
