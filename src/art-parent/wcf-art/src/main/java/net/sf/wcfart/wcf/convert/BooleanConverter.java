...
public abstract class BooleanConverter extends NodeConverterBase {
   ...
   */
  public void convert(Formatter fmt, Map<String, String[]> params, Map<String, FileItem[]> fileParams, Element elem, Object bean)
   ...
   */
  public abstract int isSelected(Element elem, Map<String, String[]> params);
